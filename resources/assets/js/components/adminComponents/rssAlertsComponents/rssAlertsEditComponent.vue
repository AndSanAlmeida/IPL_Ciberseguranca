...
<script type="text/javascript">
    ...
    export default {
        ...
        methods: {
            getUsefulLink: function() {
                axios.get('/api/rssAlerts/'+this.rss.id)
                .then((response) => {
            ...
            submitForm: function (glossaryItem) {
                ...
                if (!this.isFormInvalid) {
                    ...
                    axios.post('/api/rssAlerts/'+ this.rss.id +'/update', data)
                    .then((response) => {
                        swal("RSS alterado com sucesso.", {
                            icon: 'success',
                            buttons: {
                                ok: "Ok"
                            },
